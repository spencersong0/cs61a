...
(define (brocolito2 x) (* 2 x))
; expect brocolito2

(brocolito2 1)
; expect 2

(define llama (lambda (l) (+ l l)))
; expect llama
...
(lambda (brocolito2 brocolito) 72)
; expect (lambda (brocolito2 brocolito) 72)

(define candy (lambda (f) (* f 2)))
; expect candy

(define (josh seven hi)
  (cond ((> seven hi) seven)
        ((= seven hi) 3)
        ((< seven hi) hi)
  )
